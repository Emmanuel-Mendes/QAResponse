...
def create_app() -> Flask:
    ...
    try:
        ...
        from app.server.controllers.home.projects_list import project_blueprint
        from app.server.controllers.projects.project_home import projects_blueprint
        ...
        app_setup.register_blueprint(projects_blueprint)
